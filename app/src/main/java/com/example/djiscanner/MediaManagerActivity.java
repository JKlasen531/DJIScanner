...
public class MediaManagerActivity {
    ...
    protected void onDestroy() {
        ...
        DJIScannerApplication.getCameraInstance().setMode(SettingsDefinitions.CameraMode.SHOOT_PHOTO, new CommonCallbacks.CompletionCallback() {
            @Override
    ...
    private void initMediaManager() {
        if (DJIScannerApplication.getProductInstance() == null) {
            ...
            if (null != DJIScannerApplication.getCameraInstance() && DJIScannerApplication.getCameraInstance().isMediaDownloadModeSupported()) {
                mMediaManager = DJIScannerApplication.getCameraInstance().getMediaManager();
                if (null != mMediaManager) {
                    mMediaManager.addUpdateFileListStateListener(this.updateFileListStateListener);
                    mMediaManager.addMediaUpdatedVideoPlaybackStateListener(this.updatedVideoPlaybackStateListener);
                    DJIScannerApplication.getCameraInstance().setMode(SettingsDefinitions.CameraMode.MEDIA_DOWNLOAD, new CommonCallbacks.CompletionCallback() {
                        @Override
            ...
            } else if (null != DJIScannerApplication.getCameraInstance()
                    && !DJIScannerApplication.getCameraInstance().isMediaDownloadModeSupported()) {
